function p = ConnectGaussCompteSTP(p,fromid,toid,recept,eff,conProb,plus,minus,sigma,stp_U,stp_tauf,stp_taud)
%p = ConnectGaussCompteSTP(p,fromid,toid,recept,eff,conProb,plus,minus,sigma,stp_U,stp_tauf,stp_taud)
