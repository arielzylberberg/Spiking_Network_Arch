function p = ConnectGaussRandom(p,fromid,toid,recept,eff,plus,minus,sigma)
%p = ConnectGaussRandom(p,fromid,toid,recept,eff,plus,minus,sigma)
...
for i=1:length(from)
   ...
   p(from(i)).connection(len+1).conntype=3;
